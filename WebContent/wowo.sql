...
INSERT INTO admininfo VALUES(0,'navy',md5('123321'),'15574725601', NULL, 1),(0,'yc',md5('123321'),'17374725601', NULL, 1);
...
CREATE TABLE IF NOT EXISTS typeinfo(
	...
	tname VARCHAR(100) NOT NULL UNIQUE COMMENT '商品类型名称',
...
CREATE TABLE IF NOT EXISTS shopinfo(
	...
	sname VARCHAR(100) NOT NULL COMMENT '店铺名称',
	...
	regDate DATETIME COMMENT '注册日期',
	startHours TIME COMMENT '来时营业时间',
