...
public class BaseServlet extends HttpServlet{
	 ...
	 * @throws IOException
	 */
	protected void send(HttpServletResponse response, int code) throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	protected void send(HttpServletResponse response, String code) throws ServletException, IOException {
		response.setHeader("Access-Control-Allow-Origin", "*");
	 ...
	 * @throws IOException
	 */
	protected void send(HttpServletResponse response, int code, String msg) throws ServletException, IOException {
		response.setHeader("Access-Control-Allow-Origin", "*");
		//解决前端网页  xml解析错误: 格式不佳
		response.setContentType("application/json");
		PrintWriter out = response.getWriter();
	 ...
	 * @throws IOException
	 */
	protected void send(HttpServletResponse response, int code, Object data) throws ServletException, IOException {
		response.setHeader("Access-Control-Allow-Origin", "*");
		//解决前端网页  xml解析错误: 格式不佳
		response.setContentType("application/json");
		PrintWriter out = response.getWriter();
